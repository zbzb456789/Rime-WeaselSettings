namespace 词库管理工具
{
    partial class WubiDict
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblFilter.Font = new Font("微软雅黑", 10.5F);
            lblFilter.Location = new Point(13, 33);
            lblFilter.Name = "lblFilter";
            lblFilter.Size = new Size(93, 20);
            lblFilter.TabIndex = 2;
            lblFilter.Text = "按编码过滤：";
            // 
            // txtFilter
            // 
            txtFilter.Font = new Font("微软雅黑", 10.5F);
            txtFilter.Location = new Point(99, 30);
            txtFilter.Name = "txtFilter";
            txtFilter.Size = new Size(120, 26);
            ...
            dgvList.Columns.AddRange(new DataGridViewColumn[] { colCode, colWord, colWeight });
            ...
            // colWeight
            // 
            colWeight.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            colWeight.HeaderText = "权重";
